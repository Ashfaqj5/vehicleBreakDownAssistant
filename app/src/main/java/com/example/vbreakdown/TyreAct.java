...
public class TyreAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tyreService=findViewById(R.id.tyreService);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference=rootNode.getReference("TyreRequest");
                ...
                if(w>1 &&!ph.isEmpty()&&!m.isEmpty()&&!r.isEmpty()) {
                    ...
                    Toast.makeText(TyreAct.this,"Request sent successfully",Toast.LENGTH_LONG).show();
                    startActivity(new Intent(TyreAct.this,HomeActivity.class));
                }
                else{
                    Toast.makeText(TyreAct.this,"Fill the form completely",Toast.LENGTH_SHORT).show();
                }
//
            }
        });
    ...
    private void makePhoneCall(){
        ...
        if(ContextCompat.checkSelfPermission(TyreAct.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(TyreAct.this,
